...
router.route('/upgradeAccount')
        .post(authController.protect,authController.restrictTo('admin'),accountController.upgradeAccount)
       
router.route('/getAccount')
        .get(authController.protect,authController.restrictTo('admin'),accountController.getAccount)

router.route('/suspendAccount')
        .patch(authController.protect,authController.restrictTo('admin'),accountController.suspendAccount)

router.route('/deleteAccount')
        .post(authController.protect,authController.restrictTo('admin'),accountController.deleteAccount)
...
router.route('/updateProfile')
        .patch(authController.protect,authController.restrictTo('classCustomer','broker','seller'),accountController.updateProfile)   

                //image upload
                //user should be authenicated and the updated image must be users it self
   
router.post('/updateProfilePicture',authController.protect,upload.single('avatar'),accountController.updateProfilePicture);
